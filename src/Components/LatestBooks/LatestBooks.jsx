...
const LatestBooks = () => {
  ...
  const handlePrev = () => {
    setActiveIndex((prev) =>
      prev === 0 ? carouselBooks.length - 1 : prev - 1,
    );
  };
  ...
  return (
    <section className="py-24 px-4 bg-white dark:bg-[#0f081c] text-gray-900 dark:text-white transition-colors duration-500">
      <div className="max-w-7xl mx-auto">
        ...
        {activeBook && (
          <div className="relative bg-purple-50/50 dark:bg-[#1a0f2e] text-gray-900 dark:text-white rounded-xl overflow-hidden shadow-2xl mb-20 border-l-[12px] border-pink-500 flex flex-col md:flex-row min-h-[450px]">
            ...
            <div className="md:w-3/5 p-8 md:p-12 flex flex-col justify-center relative">
              ...
              <div className="flex items-center gap-2 mb-8">
                <p className="text-amber-500 font-semibold text-lg tracking-widest">
              ...
              <div className="mt-auto pt-8 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3 relative z-10">
                  <button
                    onClick={handlePrev}
                    className="p-2 bg-gray-200 dark:bg-white/10 hover:bg-gray-300 dark:hover:bg-white/20 rounded-full transition-colors cursor-pointer text-gray-800 dark:text-white"
                  >
                    <svg
        ...
        <div className="flex items-center gap-4 mb-8">
          <h3 className="text-2xl font-serif text-pink-500 dark:text-pink-400 italic">
            More New Arrivals
          </h3>
          <div className="flex-1 h-[1px] bg-pink-500/20"></div>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {gridBooks.map((book) => (
            <Link
              ...
              key={book._id}
              className="group bg-purple-50/50 dark:bg-[#1a0f2e] text-gray-900 dark:text-white rounded-md overflow-hidden shadow-xl hover:shadow-2xl hover:-translate-y-3 transition duration-500 border-l-4 border-pink-500 flex flex-col block"
            >
              <div className="relative overflow-hidden h-72">
                ...
                />
                {book.rating === 5 && (
                  <div className="absolute top-3 right-3 bg-pink-500 text-white text-xs font-bold rounded-full w-10 h-10 flex items-center justify-center shadow-lg shadow-pink-500/40">
                    ★5
                  </div>
                )}
              </div>
              ...
              <div className="p-5 flex flex-col flex-1">
                <p className="uppercase text-[10px] tracking-[3px] text-purple-600 dark:text-purple-400 font-semibold mb-2">
                  {book.genre}
                </p>
