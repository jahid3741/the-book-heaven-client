...
const MyBooks = () => {
  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-4 bg-gray-50 dark:bg-[#0f081c] transition-colors duration-500 relative overflow-hidden font-inter">
      <div className="absolute top-20 right-10 w-72 h-72 bg-pink-400/20 dark:bg-pink-500/10 rounded-full blur-[100px] pointer-events-none"></div>
      <div className="absolute bottom-20 left-10 w-80 h-80 bg-purple-400/20 dark:bg-purple-500/10 rounded-full blur-[100px] pointer-events-none"></div>
                      ...
                      <td className="px-6 py-4 text-center">
                        <div className="flex items-center justify-center gap-3">
                          <Link to={`/update-book/${book._id}`}>
                            <button className="bg-pink-500 hover:bg-pink-600 text-white px-5 py-2 rounded-lg text-xs tracking-wider uppercase font-bold transition-all duration-300 shadow-md shadow-pink-500/20 hover:shadow-lg hover:shadow-pink-500/40 hover:-translate-y-0.5">
                              Update
                            </button>
                          </Link>
                          ...
                          <button
                            ...
                            className="bg-transparent border border-red-500 text-red-500 hover:bg-red-500 hover:text-white px-5 py-2 rounded-lg text-xs tracking-wider uppercase font-bold transition-all duration-300 shadow-sm hover:shadow-md hover:shadow-red-500/40 hover:-translate-y-0.5"
                          >
                            Delete
                          </button>
                        </div>
